...
Function doSex(Actor Pc, Actor Npc)
	...
	if(Pc.GetLeveledActorBase().GetSex() == 1)
		...
		if (Utility.RandomInt(0, 1) == 0)
			anims =  SexLab.GetAnimationsByTags(2, "MF,Oral", "Standing,Cunnilingus,Aggressive", true)
		else
			anims =  SexLab.GetAnimationsByTags(2, "MF,Cowgirl", "Standing,Cunnilingus,Aggressive", true)
		endif
	endif
